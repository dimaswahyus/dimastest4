  ...
  <div :class="darkMode() ? 'darkBG' : 'lightBG'">
    ...
    <div class="main">
      ...
      <vue-typed-js
        ...
        :showCursor="false"
        :loop="true"
        :strings="[greetings() + ', ' + nicknames + '! ^5000', 'Whatever happens, keep breathing ^4500', 'I may not with you everyday, but I love you everyday ^4000', 'I always wanted to tell you... ^2500', 'I love you >///<']"
        :backDelay="500"
        :typeSpeed="100"
        :backSpeed="20"
        :contentType="'null'"
...
export default {
  ...
  data() {
    return {
      // prettier-ignore
      nicknames: this.random(["Hana", "Baby", "Sayang", "Hanaakuu", "Cintakuu"]),
